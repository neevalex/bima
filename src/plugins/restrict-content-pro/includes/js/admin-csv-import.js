...
var RCP_Import = {
	...
	complete: function( xhr ) {
		...
		if ( response.success ) {
			...
			$( document.body ).on( 'click', '.rcp-import-proceed', function( e ) {
				e.preventDefault();

				$( this ).parents( '.submit' ).find( '.spinner' ).addClass( 'is-active' ).show();
	...
	error: function( xhr ) {
		...
		let error_wrap = $( '#rcp-import-csv-errors' );
