...
function rcp_admin_notices() {
	...
	if( current_user_can( 'activate_plugins' ) ) {
		...
		$selected_gateways = isset( $rcp_options['gateways'] ) ? array_map( 'trim', $rcp_options['gateways'] ) : array();
		if ( array_key_exists( 'authorizenet', $selected_gateways ) && ! defined( 'RCP_ANET_VERSION' ) ) {
			echo '<div class="error">';
